...
class CustomerRegistrationForm extends Component
{
    ...
    protected $rules = [
        ...
        'formData.has_children' => 'required',
        'formData.number_of_children' => 'required_if:formData.has_children,true|nullable|integer|min:1|max:20',
    ...
    protected $messages = [
        ...
        'formData.has_children.required' => '¿Tiene hijos? es obligatorio.',
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $submission = PurchasedVehicleForm::create([
                ...
                'wants_promotions' => $this->formData['wants_promotions'],
                ...
                'has_children' => $this->formData['has_children'] === 'si' ? true : false,
                'number_of_children' => $this->formData['has_children'] === 'si' ? $this->formData['number_of_children'] : null,
                ...
                'hobbies' => !empty($this->formData['hobbies']) ? $this->formData['hobbies'] : null,
                'education_level' => $this->formData['education_level'] ?: null,
                'main_driver' => $this->formData['main_driver'] ?: null
            ]);

            Log::info('Formulario de vehículo comprado enviado:', [
            ...
            session()->flash('error', 'Ocurrió un error. Por favor intente nuevamente.');
        }
    }

    ...
    <div class="mb-6">
        <div class="flex gap-2 p-1 bg-zinc-100 dark:bg-zinc-800 rounded-lg w-fit">
            <button
                ...
                class="px-6 py-2.5 rounded-md font-medium text-sm transition-all duration-200 {{ $activeTab === 'vehicles' ? 'bg-white dark:bg-zinc-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200' }}"
            >
            ...
            <button
                ...
                class="px-6 py-2.5 rounded-md font-medium text-sm transition-all duration-200 {{ $activeTab === 'versions' ? 'bg-white dark:bg-zinc-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200' }}"
            >
                <div class="flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="group relative rounded-xl p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border border-blue-200 dark:border-blue-800 hover:shadow-lg transition-all duration-300">
            <div class="flex items-start justify-between mb-4">
                <div class="p-3 rounded-lg bg-blue-500 dark:bg-blue-600 shadow-lg">
                ...
                <div class="p-6 overflow-y-auto max-h-[60vh]">
                            ...
                            @foreach ($previewData as $row)
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800">
                                    ...
                                    @if ($activeTab === 'vehicles')
                                        ...
                                        <td class="px-4 py-3 text-blue-600 dark:text-blue-400 font-semibold">{{ $row['price_now'] }}</td>
                                    @else
                                        <td class="px-4 py-3">{{ $row['list_price'] }}</td>
                                        <td class="px-4 py-3 text-blue-600 dark:text-blue-400 font-semibold">{{ $row['final_price'] }}</td>
                                    @endif
                                    <td class="px-4 py-3">
                    ...
                    <div class="mt-4 p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
                        <div class="flex items-start gap-2">
                            <flux:icon icon="information-circle" variant="solid" class="flex-shrink-0 w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5"/>

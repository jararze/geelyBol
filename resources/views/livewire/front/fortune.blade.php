    ...
    <section class="about-section py-8" style="background-color: #fff;">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class=" mx-auto">
                    <h1 class="text-3xl leading-relaxed max-w-3xl mx-auto bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">
                ...
                <div class="bg-white py-5 px-8 rounded-lg mt-5">
                    <div class="max-w-3xl mx-auto text-center">
                        <p class="text-gray-600 text-lg mb-4 italic">
                            ...
                            En <span class="font-bold text-blue-600">Geely</span> ponemos a las personas primero,<br>
